...
import com.javaMailServerForOtp.dto.MailDto;
import com.javaMailServerForOtp.dto.otp.OtpResponse;
...
import com.javaMailServerForOtp.repo.otp.OtpRepo;
...
//    @Async
    public String sendEmail(MailDto mailDto, String token) {
        try {
